...
browser never fetches this. Exposed as `coherence.navigate vocabulary --json` so
...
VOCABULARY: dict[str, dict] = {
    ...
    "goal": {
        ...
        "definition": (
            ...
            "`coherence.goals.registry` -- the measurable engineering "
    ...
    "trace": {
        ...
        "definition": (
            ...
            "resolved through the same loader the `coherence.trace` command "
