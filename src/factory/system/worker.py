...
The docs server starts one long-lived `factory.system worker` process per
...
from factory.system.cli import (
    cmd_brief,
    cmd_diagram,
    cmd_goal_list,
    cmd_goal_show,
...
from factory.system.dossier import cmd_dossier
from factory.system.queries import ScopeError
...
def main() -> int:
    """CLI entry invoked as ``python -m factory.system worker --repo-root``."""
