# Increment 05 Reviewer Agent

Act as a strict, read-only compliance reviewer for Engineering-Context Increment 05 in
...
- docs/superpowers/plans/engineering-context/increment-05-*.md (tasks + acceptance)
