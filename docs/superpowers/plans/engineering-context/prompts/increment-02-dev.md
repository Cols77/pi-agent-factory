# Increment 02 Developer Agent

You are the developer subagent for Engineering-Context Increment 02 in
...
- docs/superpowers/plans/engineering-context/increment-02-*.md (this increment's plan)
