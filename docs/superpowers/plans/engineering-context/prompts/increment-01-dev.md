# Increment 01 Developer Agent

You are the developer subagent for Engineering-Context Increment 01 in
...
- docs/superpowers/plans/engineering-context/increment-01-*.md (this increment's plan)
