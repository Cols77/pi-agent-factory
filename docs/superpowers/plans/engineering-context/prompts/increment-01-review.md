# Increment 01 Reviewer Agent

Act as a strict, read-only compliance reviewer for Engineering-Context Increment 01 in
...
- docs/superpowers/plans/engineering-context/increment-01-*.md (tasks + acceptance)
