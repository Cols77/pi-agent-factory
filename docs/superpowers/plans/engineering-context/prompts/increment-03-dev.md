# Increment 03 Developer Agent

You are the developer subagent for Engineering-Context Increment 03 in
...
- docs/superpowers/plans/engineering-context/increment-03-*.md (this increment's plan)
