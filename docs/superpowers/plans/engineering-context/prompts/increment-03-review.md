# Increment 03 Reviewer Agent

Act as a strict, read-only compliance reviewer for Engineering-Context Increment 03 in
...
- docs/superpowers/plans/engineering-context/increment-03-*.md (tasks + acceptance)
