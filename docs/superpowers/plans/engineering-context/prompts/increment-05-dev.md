# Increment 05 Developer Agent

You are the developer subagent for Engineering-Context Increment 05 in
...
- docs/superpowers/plans/engineering-context/increment-05-*.md (this increment's plan)
