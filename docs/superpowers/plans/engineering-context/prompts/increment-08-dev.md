...
- D7: diagrams are canonical committed HTML authored via `.pi/skills/diagram-design`; never
  re-derive a graph in TS. D8: comprehension = the installed grill-understanding/visual-explainer
  skills; do not build a quiz engine or a comprehension score.
