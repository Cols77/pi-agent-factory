# Increment 06 Reviewer Agent

Act as a strict, read-only compliance reviewer for Engineering-Context Increment 06 in
...
- docs/superpowers/plans/engineering-context/increment-06-*.md (tasks + acceptance)
