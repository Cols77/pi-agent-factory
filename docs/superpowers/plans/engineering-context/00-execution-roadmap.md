...
PHASE 4  v2 Inc 7   context delta + goal-aware validation status (+ Catch me up)
──────────────────────────────────────────────────────────────────────────
...
| Inc 7 (context delta) | Inc 2/3, Inc 6 | + "Catch me up" view |

## Decision cross-reference (D1–D6)
